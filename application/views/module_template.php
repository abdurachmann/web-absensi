...
<!--[if gt IE 9]><!--> <html class="no-focus" lang="en"> <!--<![endif]-->
    <head>
        ...
        <title>Absensi PT Dinus Cipta Mandiri | {title}</title>
    ...
    <body>
        ...
        <div id="page-container" class="sidebar-l sidebar-o side-scroll header-navbar-fixed">
                    ...
                    <div class="sidebar-content">
                        ...
                        <div class="side-header side-content bg-white">
                            ...
                            <a class="h5 text-white" href="<?php echo site_url(); ?>">
                                <img src="<?=base_url()?>assets/upload/logo/logo.jpeg" width="50px" style="margin-left: 50%; margin-right: 50%; transform: translate(93%, -10%);">
                            </a>
                        </div>
                        <!-- END Side Header -->
            ...
            <footer id="page-footer" class="content-mini content-mini-full font-s12 bg-gray-lighter clearfix">
                <div class="pull-left">
                    <a class="font-w600" href="#" target="_blank">Absensi PT Dinus Cipta Mandiri</a> &copy; 2018</span>
                </div>
            </footer>
            <!-- END Footer -->
        </div>
